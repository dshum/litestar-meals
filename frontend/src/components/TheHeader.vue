    ...
    <div class="container">
      <nav class="flex justify-between items-center h-16 py-2">
        ...
        <ul class="flex items-center gap-[4vw]">
          <li>
            <RouterLink :to="{name: 'products'}" class="btn btn-ghost text-base font-normal">Products</RouterLink>
          </li>
        </ul>
        ...
        <div class="dropdown dropdown-end dropdown-hover">
          ...
          <ul tabindex="0" class="dropdown-content z-[1] bg-base-100 rounded-box shadow w-52 p-2 menu">
            <li class="menu-title">
